...
export function PptCompress() {
    ...
    const analyzeFile = async (file: File, selectedMode: CompressionMode) => {
        try {
            ...
            // Cap at 90% file size just in case, min 0
    ...
    const compressImage = async (blob: Blob): Promise<Blob> => {
        return new Promise((resolve, reject) => {
            ...
            img.onload = () => {
                ...
                const MAX_DIM = 1600; // Slightly larger for PPT slides
    ...
    const performCompression = async () => {
        ...
        try {
            ...
            if (mode === "heavy") {
                const mediaKeys = Object.keys(zip.files).filter(k => k.startsWith("ppt/media/") && k.match(/\.(jpg|jpeg|png)$/i));
    ...
    const handleSave = (filename: string) => {
        ...
        saveAs(compressedBlob, `${filename}.pptx`);
        ...
        <div className="min-h-screen bg-slate-950 text-slate-100 p-4 md:p-8 font-sans selection:bg-blue-500/30">
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-slate-800">
                    <div className="space-y-2">
                        ...
                        <p className="text-slate-400 max-w-lg leading-relaxed">
                            Minimize PowerPoint file size by optimizing internal XML structure and assets.
                        </p>
                    </div>
                        ...
                        >
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="grid grid-cols-2 gap-2 p-1 rounded-xl bg-slate-950 border border-slate-800">
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    mode === "standard" ? "bg-blue-600 text-white shadow-lg" : "text-slate-400 hover:text-white hover:bg-slate-800"
                                                )}
                                            >
                                                <FileText size={16} />
                                            ...
                                            <button
                                                ...
                                                className={cn(
                                                    "flex flex-col items-center gap-1 py-3 px-2 rounded-lg transition-all",
                                                    mode === "heavy" ? "bg-blue-600 text-white shadow-lg" : "text-slate-400 hover:text-white hover:bg-slate-800"
                                                )}
                                            >
                                                <ImageIcon size={16} />
                                        ...
                                        <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 space-y-2">
                                            <div className="flex items-start gap-2">
                                                <Zap className={cn("w-4 h-4 mt-0.5 text-blue-400")} />
                                                <p className="text-xs text-slate-400 leading-relaxed">
                                                    {mode === "standard" ? "Optimizes XML structure. Safe and lossless." : "Re-compresses images + XML. Aggressive space saving."}
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <Button
                                            ...
                                            className={cn(
                                                "w-full h-14 font-black rounded-xl uppercase tracking-widest shadow-lg active:scale-[0.98] transition-all",
                            ...
                            <div className="lg:col-span-2">
                                <div className="p-8 md:p-12 rounded-[2.5rem] bg-slate-900/50 border border-slate-800 flex flex-col justify-center min-h-[500px] relative overflow-hidden">
                                    <div className="absolute top-0 right-0 w-64 h-64 blur-[100px] pointer-events-none transition-colors duration-500 bg-blue-500/10" />
                                    ...
                                    {stats ? (
                                        <div className="relative z-10 text-center space-y-8 animate-in fade-in zoom-in duration-300">
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 py-6">
                                                    ...
                                                    <div className="space-y-1">
                                                        <p className="text-[10px] uppercase font-bold text-blue-400 tracking-widest">Optimized</p>
                                        ...
                                        <div className="relative z-10 text-center space-y-6">
                                            <div className="w-24 h-24 rounded-3xl flex items-center justify-center mx-auto transition-colors duration-300 bg-blue-500/20 text-blue-400 border border-blue-500/20">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <p className="text-slate-400 max-w-md mx-auto leading-relaxed">
                                                    Standard mode removes metadata and whitespace. Heavy mode also compresses images.
                                                </p>
                                            </div>
                                        </div>
                                    )}
                ...
                <DownloadConfirmDialog
                    ...
                    defaultFileName={selectedFile ? `${selectedFile.name.replace(/\.[^/.]+$/, "")}_opt` : "presentation_opt"}
                    extension="pptx"
                    isProcessing={false}
                    title="Save Optimized Presentation"
                    description={`Save the compressed file (${mode} mode).`}
                />
            </div>
        </div>
    );
